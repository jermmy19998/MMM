...
def train(datasets: tuple, cur: int, args: Namespace):
    ...
    elif args.model_type == 'mmm':
        from models.model_mmm import MMM
        args.in_dim = 1024
        args.hidden_dim = [256, 128]        
        model_dict = {'omic_sizes': args.omic_sizes, 'n_classes': args.n_classes,'hidden_dim':args.hidden_dim,'in_dim':args.in_dim}
        model = MMM(**model_dict)
        table_data = [[key, value] for key, value in model_dict.items()]
        model_dict["lr"] = args.lr
    else:
        raise NotImplementedError
    ...
    for epoch in range(args.start_epoch,args.max_epochs):
        if args.mode == 'coattn':
            ...
            elif args.model_type == 'mome' or args.model_type == 'motcat' or args.model_type == 'mmm':
